...
$lang = array_merge($lang, array(
	...
	'tokens'	=>	array(
		'TEXT'			=> 'Běžný text, vč. diakritiky, zvláštních znaků, číslic, atd.',
		'SIMPLETEXT'	=> 'Znaky latinské abecedy (A–Z), číslice, mezery, čárky, tečky, mínus, plus, spojovník a podtržítko',
		'INTTEXT'		=> 'Běžný text vč. diakritiky, číslice, mezery, čárky, tečky, minus, plus, pomlčka a podtržítko. Nedovoluje speciální znaky jako TEXT',
		'IDENTIFIER'	=> 'Znaky latinské abecedy (A–Z), číslice, spojovník a podtržítko',
		...
		'ALNUM'			=> 'Znaky latinské abecedy (A-Z) a číslice.',
		'CHOICE'		=> 'Výběr určitých hodnot, např. <samp>{CHOICE=spades,hearts,diamonds,clubs}</samp>. Hodnoty ve výchozím nastavení nerozlišují velká a malá písmena. To lze změnit uvedením možnosti <samp>caseSensitive</samp>: <samp>{CHOICE=Spades,Hearts,Diamonds,Clubs;caseSensitive}</samp>',
		'FLOAT'			=> 'Desetinné číslo, např. <samp>0.5</samp>.',
		'HASHMAP'		=> 'Mapuje textové řetězce na jejich náhradu ve formě <samp>{HASHMAP=string1:replacement1,string2:replacement2}</samp>. Zohledňuje velká a malá písmena. Ve výchozím nastavení zachovává neznámé hodnoty.',
		'INT'			=> 'Celé číslo, např. <samp>2</samp>.',
		'IP'			=> 'Platná IPv4 nebo IPv6 adresa.',
		'IPPORT'		=> 'Platná IPv4 nebo IPv6 adresa s číslem portu.',
		'IPV4'			=> 'Platná IPv4 adresa.',
		'IPV6'			=> 'Platná IPv6 adresa.',
		'MAP'			=> 'Mapuje textové řetězce na jejich náhradu ve formě <samp>{MAP=string1:replacement1,string2:replacement2}</samp>. Nezohledňuje velká a malá písmena. Ve výchozím nastavení zachovává neznámé hodnoty.',
		'RANGE'			=> 'Přijímá celé číslo v zadaném rozpětí, např. <samp>{RANGE=-10,42}</samp>.',
		'REGEXP'		=> 'Validuje hodnotu oproti zadanému regulárnímu výrazu, např. <samp>{REGEXP=/^foo\w+bar$/}</samp>.',
		'TIMESTAMP'		=> 'Časové razítko jako např. <samp>1h30m10s</samp>, které bude konvertováno na počet sekund. Přijímá také číslo.',
		'UINT'			=> 'Celé číslo bez znaménka. Stejné jako <samp>{INT}</samp>, ale odmítá hodnoty menší než 0.',
	),
));
