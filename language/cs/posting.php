...
$lang = array_merge($lang, array(
	...
	'BBCODE_C_HELP'				=> 'Zobrazení kódu: [code]code[/code]',
	'BBCODE_D_HELP'				=> 'Flash: [flash=šířka,výška]http://url[/flash]',
	...
	'BBCODE_L_HELP'				=> 'Seznam: [list][*]text[/list]',
	'BBCODE_LISTITEM_HELP'		=> 'Položka seznamu: [*]text',
	'BBCODE_O_HELP'				=> 'Uspořádaný seznam: [list=]text[/list]',
	'BBCODE_P_HELP'				=> 'Vložit obrázek: [img]http://image_url[/img]',
	'BBCODE_Q_HELP'				=> 'Citace: [quote]text[/quote]',
	'BBCODE_S_HELP'				=> 'Barva písma: [color=red]text[/color] nebo [color=#FF0000]text[/color]',
	'BBCODE_U_HELP'				=> 'Podtržené: [u]text[/u]',
	'BBCODE_W_HELP'				=> 'Vložit URL: [url]http://url[/url] nebo [url=http://url]text URL[/url]',
	...
	'CANNOT_EDIT_POST_LOCKED'	=> 'Tento příspěvek je zamknutý. Nemůžete tento příspěvek upravit.',
	...
	'EDIT_REASON'				=> 'Důvod úpravy příspěvku',
	...
	'GENERAL_UPLOAD_ERROR'		=> 'Nelze odeslat soubor do %s',
	...
	'SAVE_DRAFT_CONFIRM'		=> 'Do konceptů se ukládá pouze předmět a text příspěvku. Ostatní prvky budou odstraněny. Přejete si koncept uložit?',
	'SMILIES'					=> 'Smajlíci',
	'SMILIES_ARE_OFF'			=> 'Smajlíci jsou <em>vypnutí</em>',
	'SMILIES_ARE_ON'			=> 'Smajlíci jsou <em>zapnutí</em>',
	'STICKY_ANNOUNCE_TIME_LIMIT'=> 'Časový limit Důležité/Oznámení/Globální',
	'STICK_TOPIC_FOR'			=> 'Zvolit jako důležité pro',
	'STICK_TOPIC_FOR_EXPLAIN'	=> 'Zadejte 0 pro nekončící důležité/oznámení/globální. Počet dní se počítá od odeslání příspěvku.',
