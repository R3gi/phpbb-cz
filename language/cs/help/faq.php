...
$lang = array_merge($lang, array(
	...
	'HELP_FAQ_LOGIN_REGISTER_ANSWER'	=> 'Možná nemusíte, záleží na administrátorovi fóra, jestli nastaví, že uživatel musí být přihlášen, aby mohl odesílat příspěvky. Nicméně registrací získáte přístup k dalším funkcím, které nejsou pro nepřihlášené uživatele dostupné, jako je například možnost použití vlastních avatarů, posílání soukromých zpráv a e-mailů ostatním členům fóra atd. Registrace trvá jen chvíli a tak vám ji můžeme doporučit.',
	...
	'HELP_FAQ_USERSETTINGS_EMAIL_LOGIN_ANSWER'	=> 'Jen registrovaní uživatelé můžou posílat e-maily ostatním členům fóra přes vestavěný formulář a to jen v případě, že administrátor tuto funkci povolil. Je to z důvodu zabránění zneužití emailového systému anonymními uživateli.',
	'HELP_FAQ_USERSETTINGS_EMAIL_LOGIN_QUESTION'	=> 'Když chci poslat e-mail uživateli fóra, musím se přihlásit?',
