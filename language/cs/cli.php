...
$lang = array_merge($lang, array(
	...
	'CLI_DESCRIPTION_FIX_LEFT_RIGHT_IDS'		=> 'Opraví stromovou strukturu fór a modulů.',
	...
	'CLI_DESCRIPTION_REPARSER_REPARSE_OPT_FORCE_BBCODE'	=> 'Reparsovat všechny BBCodes bez výjimek. Všechny dříve vypnuté BBCodes budou znovu zpracovány, zapnuty a plně vykresleny.',
	...
	'CLI_DESCRIPTION_USER_DELETE_ID'			=> 'Smazat uživatelské účty dle ID.',
	'CLI_DESCRIPTION_USER_DELETE_ID_OPTION_ID'	=> 'ID uživatelů určených ke smazání',
	...
	'CLI_EXTENSION_NOT_EXIST'			=> 'Rozšíření %s neexistuje',
	...
	'CLI_EXTENSION_NOT_ENABLEABLE'		=> 'Rozšíření %s není možné povolit.',
	'CLI_EXTENSIONS_AVAILABLE'			=> 'Dostupné',
	'CLI_EXTENSIONS_DISABLED'			=> 'Zakázané',
	'CLI_EXTENSIONS_ENABLED'			=> 'Povolené',

	'CLI_FIXUP_FIX_LEFT_RIGHT_IDS_SUCCESS'		=> 'Úspěšně opraven strom struktury fór a modulů.',
	'CLI_FIXUP_UPDATE_HASH_BCRYPT_SUCCESS'		=> 'Úspěšně aktualizovány zastaralé hesla použitím bcryptu.',
	...
	'CLI_REPARSER_REPARSE_REPARSING'		=> 'Reparsování %1$s (řádek %2$d – %3$d)',
	'CLI_REPARSER_REPARSE_REPARSING_START'	=> 'Reparsování %s…',
	...
	'CLI_USER_DELETE_ID_CONFIRM'	=> 'Opravdu chcete smazat uživatele s ID „%s“? [y/N]',
	'CLI_USER_DELETE_ID_SUCCESS'	=> 'Uživatelé s uvedeným ID úspěšně smazáni.',
	'CLI_USER_DELETE_ID_START'		=> 'Odstraňování uživatelů dle ID',
	'CLI_USER_DELETE_NONE'			=> 'Nebyli odstraněni žádní uživatelé dle ID.',
